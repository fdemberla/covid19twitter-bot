...
def extractor_de_datos():
    ...
    browser = webdriver.Chrome(
        executable_path=r"C:\Users\fernando_Dember\Apps\chromedriver.exe", chrome_options=options)
    ...
    lista_div_id = [{"nombre": "casos", "id": "ember12"}, {"nombre": "casos_por_corregimiento", "id": "ember46"}, {
        "nombre": "casos_por_genero", "id": "ember54"}, {"nombre": "cantidad_de_pruebas", "id": "ember113"}, {"nombre": "rango_de_edades", "id": "ember27"}]
